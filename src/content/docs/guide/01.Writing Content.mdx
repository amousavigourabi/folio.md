...
Every page is a `.mdx` file. MDX is a superset of Markdown that can import and render React components, but all standard Markdown syntax works just fine when you don't need components.
