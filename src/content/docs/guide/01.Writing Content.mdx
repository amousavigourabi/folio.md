...
description: MDX features, diagrams, code blocks, page settings, and sidebar ordering.
keywords: [MDX, Mermaid, callouts, syntax highlighting, page settings, task lists]
---
...
folio.md uses `title` as the page heading, browser tab title, and search result title. Set `description` to control the search snippet and social card preview. See [Page Settings](/reference/frontmatter) for the full list of options.
