...
| [Writing Content](/guide/writing-content) | MDX, Mermaid, code blocks, page settings |
| [Page Features](/guide/page-features) | ToC, reading time, heading anchors, last-updated dates, link validation, view transitions |
